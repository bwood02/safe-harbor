#!/usr/bin/env python3
"""Train reintegration readiness RF from repo data/; write models/reintegration_rf.joblib."""
...
from ml_service.features.reintegration_readiness import (  # noqa: E402
    build_reintegration_model_df,
    train_reintegration_rf,
)
...
def main() -> None:
    ...
    parser.add_argument(
        "--out",
        type=Path,
        default=_REPO_ROOT / "models" / "reintegration_rf.joblib",
    )
    ...
    df = build_reintegration_model_df(data_dir)
    pipe, feature_cols = train_reintegration_rf(df)
